...
//   " in printf   //
////////////////////
printf( "enter \"1\" to use (Item, Cost), Discount function. Enter the number of items names, and their names comma seperated by their values. ex: \"name\" 1. Then the percent discounted. " )
...
while (run_UI != "quit")
{
  ...
  //   Blank Map     //
  /////////////////////
  //var maped_items = scala.collection.mutable.Map[String,Double]()               
  //var maped_items = scala.collection.mutable.Map[String](Double)
  ...
  {  
    ...
    //maped_items(user_input_key) = user_input_value
    maped_items = maped_items + ((user_input_key, user_input_value))//scala.collection.mutable.Map((user_input_key, user_input_value)) 
  }
